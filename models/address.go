...
type Address struct {
	...
	ProvinceID   utils.Int64Str  `gorm:"index;not null" json:"provinceId"`
	CityID       utils.Int64Str  `gorm:"index;not null" json:"cityId"`
	DistrictID   utils.Int64Str  `gorm:"index;not null" json:"districtId"`
